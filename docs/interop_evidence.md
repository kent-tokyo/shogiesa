...
| KIF -> JSONL | `sample.kif`, `sample_handicap.kif`, `malformed.kif`, `no-terminal.kif`, `variation.kif`, `nested_variation.kif` | mainline, handicap, malformed/unterminated input, flat and indentation-nested variation provenance | arbitrary KIF dialects or unindented nested-branch conventions |
