...
| JSONL -> pack -> JSONL | `tests/fixtures/pack_input.jsonl`, `shogiesa-pack` tests, and CLI schema fixtures v1-v11 | current format 11 round-trips through JSONL; pack manifest records artifact hash and counts | editing pack as a primary format |
